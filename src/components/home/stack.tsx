  ...
  return (
    <div className="w-full my-10 flex flex-col gap-9 px-4">
      ...
      <div className="flex gap-3 w-full flex-wrap justify-center md:justify-normal">
        <Tooltip content="Next.js" className="bg-bgCard text-white">
        ...
        <Tooltip content="React.js" className="bg-bgCard text-white">
          <div className="bg-bgButton w-[120px] h-[70px] rounded flex flex-col justify-center items-center hover:bg-hoverCard transition-all ease-linear">
            <Image src="/react.svg" alt="" width={50} height={50} />
          </div>
        </Tooltip>
        <Tooltip content="React Query" className="bg-bgCard text-white">
          <div className="bg-bgButton w-[120px] h-[70px] rounded flex flex-col justify-center items-center hover:bg-hoverCard transition-all ease-linear">
            <Image src="/react-query.svg" alt="" width={50} height={50} />
          </div>
        </Tooltip>
        <Tooltip content="Typescript" className="bg-bgCard text-white">
          <div className="bg-bgButton w-[120px] h-[70px] rounded flex flex-col justify-center items-center hover:bg-hoverCard transition-all ease-linear">
            <Image src="/types.svg" alt="" width={40} height={40} />
          </div>
        </Tooltip>
        <Tooltip content="Java" className="bg-bgCard text-white">
          <div className="bg-bgButton w-[120px] h-[70px] rounded flex flex-col justify-center items-center hover:bg-hoverCard transition-all ease-linear">
            <Image src="/java.svg" alt="" width={50} height={50} />
          </div>
        </Tooltip>
        <Tooltip content="Spring Boot" className="bg-bgCard text-white">
          <div className="bg-bgButton w-[120px] h-[70px] rounded flex flex-col justify-center items-center hover:bg-hoverCard transition-all ease-linear">
            <Image src="/spring.svg" alt="" width={50} height={50} />
          </div>
        </Tooltip>
        <Tooltip content="Docker" className="bg-bgCard text-white">
          <div className="bg-bgButton w-[120px] h-[70px] rounded flex flex-col justify-center items-center hover:bg-hoverCard transition-all ease-linear">
