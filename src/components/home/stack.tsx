    ...
    <div className="w-full my-10 flex flex-col gap-9 px-4">
      ...
      <div className="flex gap-3 w-full flex-wrap justify-center md:justify-normal">
        <Tooltip content="Next.js" className="bg-[--bg-card] text-white">
          <div className="bg-[--bg-button] w-[120px] h-[70px] rounded flex flex-col justify-center items-center hover:bg-[--hover-card] transition-all ease-linear">
            <Image
              src="/next.svg"
              alt=""
              width={70}
              height={70}
              className="hover:fill-black fill-current"
            />
          </div>
        </Tooltip>
