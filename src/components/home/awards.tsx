        ...
        <div className="flex flex-col gap-5 w-full md:w-1/2">
          ...
          >
            <h2 className="text-2xl font-bold flex items-top gap-1 md:mb-5">
              ...
              <ArrowUpRight size={18} className="text-headerLink" />
            </h2>
          </Link>
          <a
            href="https://github.com/Carlos-Landerdahl/Carhub"
            target="_blank"
            className="bg-bgCard p-3 px-4 rounded flex gap-1 flex-col hover:bg-hoverCard transition-all ease-linear hover:border-transparent"
          >
        ...
        <div className="flex flex-col mt-5 gap-5 w-full md:w-1/2 md:mt-0">
          <div>
            <h2 className="text-2xl font-bold flex items-center gap-1 md:mb-5">
              Últimas conquistas
              <AwardIcon size={25} className="text-headerLink" />
            </h2>
          </div>
          <div className="flex gap-2 flex-col py-2 px-2">
            ...
            <div className="border border-border2 my-5" />
          </div>
