      ...
      tabs: [
        {
          ...
          content: (
            <p>
              ...
              desenvolvimento web. Utilizo tecnologias como Next.js e
              TypeScript. Além disso, criei um painel personalizado para a
              empresa, o qual permitiu a conversão de dados da API em formato
              Excel, com vários filtros para facilitar a extração de
              informações. Também desempenho um papel fundamental na
              digitalização da empresa, desenvolvendo soluções para automatizar
      ...
      tabs: [
        {
          ...
          content: (
            <p>
              ...
              desempenhar papéis variados, adaptando-me às demandas específicas
              de cada projeto. Além disso, participei ativamente na comunidade{' '}
              <Link
                isExternal
              ...
              desenvolvimento e manutenção de sistemas, onde pude oferecer
              suporte especializado e implementar inovações tecnológicas para
              impulsionar o progresso dos projetos. Além dessas experiências,
              ampliei meu escopo de atuação realizando trabalhos freelancers por
              meio das plataformas GetNinjas e Workana.
            </p>
          ),
        },
        {
